...
<div>
  ...
  <img id="image" src="img/chinesa.jpg" style="width:100%; ">
...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre os melhores restaurantes Chineses </h3>
</nav>
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Restaurante China</h5>
      <p class="card-text">Comida caseira chinesa, como rolinhos primavera e carnes com molhos, mais sushis, em casa que também entrega.</p>
      <a href="china.php" class="btn btn-outline-dark">Visitar</a>
