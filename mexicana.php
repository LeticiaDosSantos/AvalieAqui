...
<br>
 <nav class="nav justify-content-center"> 
  <a class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre os melhores restaurantes Mexicanos </a>
</nav>
...
<div class="row"  style="margin-left: 3%;width: 40rem;">
  <div class="col-sm-6" >
    <div class="card">
      <div class="card-body">
        <img src="guacamole.png" class="card-img" alt="..." >
