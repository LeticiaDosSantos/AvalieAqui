...
<div>
  ...
  <img id="image" src="img/cafeteria.jpg" style="width:100%; ">
...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre as melhores Cafeterias </h3>
</nav>
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Amigo Paul Café Bistrô</h5>
      <p class="card-text">Variedade de cafés, salgados e doces, destaque à quiche e ao brownie, mais compota com creme de cacau e avelã.</p>
      <a href="amigoPaul.php" class="btn btn-outline-dark">Visitar</a>
