...
//      $id_rest = $_POST['id_rest'];
    	...
    	if($validacao)
    	{
	        ...
	        $sql = "INSERT INTO restaurante (nome, descricao, telefone, estado, endereco, cidade, numero) VALUES(?,?,?,?,?,?,?)";
	        $q = $pdo->prepare($sql);
	        $q->execute(array($nome, $descricao, $telefone, $estado, $endereco, $cidade, $numero));
