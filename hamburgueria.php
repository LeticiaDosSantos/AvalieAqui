...
<br>
 <nav class="nav justify-content-center"> 
  <a class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre as melhores Hamburguerias </a>
</nav>
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="madero.php" class="btn btn-outline-dark">Visitar</a>
