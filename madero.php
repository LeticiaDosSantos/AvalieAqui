...
<br>
 <nav class="nav justify-content-center"> 
  <a class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Restaurante Madero </a>
</nav>
<br>
<br>
...
<div class="container">
  ...
  <div class="card" style="width: 70rem;">
    ...
    <img src="img/madero.png" class="card-img-top" alt="..." style="width: 100%;">
