...
<?php
  //require 'banco.php';
    ...
    //Validaçao dos campos:
		...
		if(empty($nome))
		{
			$erroMsg = 'Por favor digite o nome do restaurante!';
			$validacao = false;
		}

    if(empty($descricao))
    {
      $erroMsg = 'Por favor faça uma breve descrição';
      $validacao = false;
    }
    if(empty($categoria))
    {
    	$erroMsg = 'Por favor selecione uma categoria';
    	$validacao = false;
    }

    if(empty($telefone))
    {
    	$erroMsg = 'Por favor insira um telefone válido';
    	$validacao = false;
    }

    if(empty($horario_funcionamento))
    {
    	$erroMsg = 'Por favor adicione o horário de funcionamento';
    	$validacao = false;
    }

    elseif(empty($estado))
    {
    	$erroMsg = 'Por favor selecione um estado';
    	$validacao = false;
    }

    if(empty($endereco))
    {
    	$erroMsg = 'Por favor digite o endereço do restaurante!';
    	$validacao = false;
    }

    if(empty($cidade))
    {
      $erroMsg = 'Por favor digite a cidade do restaurante!';
     	$validacao = false;
    }

    if(empty($numero))
    {
      $erroMsg = 'Por favor digite o numero do restaurante!';
      $validacao = false;
    }
