...
<div>
  ...
  <img id="image" src="img/feijoada.jpg" style="width:100%; ">
...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre os melhores restaurantes Brasileiros </h3>
</nav>
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Mocotó</h5>
      <p class="card-text">O Mocotó se define como um restaurante de comida sertaneja nordestina democrático. </p>
      <a href="mocoto.php" class="btn btn-outline-dark">Visitar</a>
