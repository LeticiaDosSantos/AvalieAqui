...
<div>
  ...
  <img id="image" src="img/tailandesa.jpg" style="width:100%; ">
...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre os melhores restaurantes Tailandeses </h3>
</nav>
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Chansu Asian Cuisine</h5>
      ...
      <a href="chansuAC.php" class="btn btn-outline-dark">Visitar</a>
