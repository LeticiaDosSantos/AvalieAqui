...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;"> Didge Steakhouse Pub </h3>
</nav>
<br>
<br>
...
<div class="container">
  ...
  <div class="card" style="width: 70rem;">
     <div class="card-body">
     <p class="card-text">Steakhouse com tradicionais costelas ao molho barbecue, chopes e clima de pub australiano, ao som de rock.</p>
    </div>
