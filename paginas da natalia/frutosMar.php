...
<div>
  ...
  <img id="image" src="img/frutos.jpg" style="width:100%; ">
...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre os melhores restaurantes de  Frutos do Mar </h3>
</nav>
...
<div class="card-deck">
  <div class="card">
    <img src="img/siriCascudoo.jpeg" class="card-img-top" alt="..." style="height: 49%;"><!--esse height regula pra ficar do tamanho dos outros-->
    <div class="card-body">
      <h5 class="card-title">Siri Cascudo</h5>
      <p class="card-text">Siri, camarões e ostras, além de peixes, lula e bolinhos, em casa com deck, mezanino e clima descontraído.</p>
      <a href="siriCascudo.php" class="btn btn-outline-dark">Visitar</a>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="casaEuropa.php" class="btn btn-outline-dark">Visitar</a>
