...
<div>
  ...
  <img id="image" src="img/francesaa2.jpg" style="width:100%; ">
...
<br>
 <nav class="nav justify-content-center"> 
  <h3 class="nav-link" href="#" style="color: black; font-size: 30px; font-family:all;">Encontre os melhores restaurantes Franceses </h3>
</nav>
...
<div class="card-deck">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="italiaMia.php" class="btn btn-outline-dark">Visitar</a>
     
    </div>
  </div>
  <div class="card">
    <img src="img/francesaa.jpg" class="card-img-top" alt="..." style="height: 49%;">
    <div class="card-body">
      <h5 class="card-title">L'Arpège</h5>
      <p class="card-text">O Arpège é um restaurante francês de 3 estrelas Michelin em Paris. O chef é Alain Passard.</p>
      <a href="LArpege.php" class="btn btn-outline-dark">Visitar</a>
